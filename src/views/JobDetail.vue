...
<template>
  <div class="min-h-screen bg-[#F9FAFB] pb-24">
    ...
    <div class="flex justify-between items-center p-4">
      ...
      <button
        @click="goBack"
        class="bg-orange-400 text-white px-4 py-2 rounded-full text-sm flex items-center gap-2"
      >
        ← Go back
      </button>
    ...
    <div class="fixed bottom-0 left-0 w-full bg-white p-4 shadow-md">
      <button
        class="w-full bg-orange-400 text-white py-3 rounded-full font-semibold"
      >
        Apply
      </button>
    </div>
