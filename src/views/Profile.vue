<template>
  <div class="relative w-full max-w-[850px] mx-auto z-10 transition-all">
    ...
    <div class="relative bg-[#FFF8F1]/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-[36px] shadow-[0_10px_50px_rgba(0,0,0,0.05)] border border-[#EBEBEB] dark:border-gray-800 p-5 md:p-8 flex flex-col gap-6 md:gap-8 z-10 group/wrapper">
      ...
      <div class="relative overflow-hidden bg-[#FFFFFF] dark:bg-gray-800 rounded-[22px] shadow-[0_4px_25px_rgba(0,0,0,0.02)] p-6 md:p-7 flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-start group transition-all duration-500 hover:shadow-[0_15px_50px_rgba(239,119,34,0.08)] border border-[#EBEBEB] dark:border-gray-700 z-10">
        ...
        <div class="relative shrink-0 mt-3 md:mt-2">
          ...
          <div class="relative w-28 h-28 md:w-24 md:h-24 bg-[#FFFFFF] dark:bg-gray-800 rounded-full shadow-[inset_0_-4px_10px_rgba(239,119,34,0.1)] border-[4px] border-[#FFF8F1] dark:border-gray-900 z-10 overflow-hidden flex items-center justify-center transform group-hover:scale-105 transition-all duration-500 ring-4 ring-[#FFFFFF] dark:ring-gray-800">
             ...
             <div class="absolute inset-0 border border-[#EBEBEB]/20 dark:border-gray-700/20 rounded-full"></div>
          </div>
        </div>
        
        <div class="flex flex-col mt-2 gap-1.5 text-center md:text-left flex-grow z-10">
          <h3 class="text-[20px] font-extrabold text-[#1F2937] dark:text-gray-100 tracking-tight mt-1">{{ safeProfile.name }}</h3>
          <p class="text-[14px] font-medium text-[#6B7280] dark:text-gray-300 tracking-wide mt-0.5">{{ safeProfile.university }}</p>
          <p class="text-[13px] text-[#6B7280]/80 dark:text-gray-400 mt-1">{{ formattedDob }}</p>
        </div>

        <div class="md:absolute md:bottom-7 md:right-7 flex gap-2.5 mt-4 md:mt-0 z-10">
          <button @click="openEditModal" class="bg-[#FFF8F1] dark:bg-gray-700 hover:bg-[#FFFFFF] dark:hover:bg-gray-600 text-[#1F2937] dark:text-gray-200 hover:text-[#EF7722] font-bold text-[13px] py-1.5 px-6 rounded-full transition-all duration-300 active:scale-95 shadow-sm border border-[#EBEBEB] dark:border-gray-600 hover:border-[#FAA533] flex items-center gap-1.5 cursor-pointer">
      ...
      <div class="relative overflow-hidden bg-[#FFFFFF] dark:bg-gray-800 rounded-[22px] shadow-[0_4px_25px_rgba(0,0,0,0.02)] p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-start group transition-all duration-500 hover:shadow-[0_15px_50px_rgba(239,119,34,0.08)] border border-[#EBEBEB] dark:border-gray-700 z-10">
        ...
        <div class="flex flex-col w-full mt-1.5 text-center md:text-left z-10">
          <div class="flex flex-col sm:flex-row justify-between items-center sm:items-start mb-6 gap-3">
            <h3 class="text-[#1F2937] dark:text-gray-100 text-[16px] font-extrabold tracking-tight flex items-center gap-2 justify-center md:justify-start">
            ...
            <div class="relative group/select">
                <select v-model="selectedYear" class="bg-[#FFF8F1] dark:bg-gray-700 border border-[#EBEBEB] dark:border-gray-600 text-[#1F2937] dark:text-gray-200 text-[12px] font-bold rounded-full pl-4 pr-8 py-1.5 outline-none cursor-pointer group-hover/select:border-[#FAA533] transition-colors hover:bg-white dark:hover:bg-gray-600 shadow-sm appearance-none min-w-[110px]">
      ...
      <div class="relative overflow-hidden bg-[#FFFFFF] dark:bg-gray-800 rounded-[22px] shadow-[0_4px_25px_rgba(0,0,0,0.02)] p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-start group transition-all duration-500 hover:shadow-[0_15px_50px_rgba(239,119,34,0.08)] border border-[#EBEBEB] dark:border-gray-700 z-10">
        ...
        <div @click="isQrModalOpen = true" class="w-24 h-24 bg-[#FFF8F1] dark:bg-gray-700 rounded-[28px] shrink-0 flex items-center justify-center font-bold text-[13px] text-[#1F2937]/40 dark:text-gray-300 shadow-[inset_0_2px_10px_rgba(0,0,0,0.03)] border border-[#EBEBEB]/60 dark:border-gray-600 relative group-hover:border-[#FAA533]/40 transition-all duration-500 z-10 overflow-hidden cursor-pointer hover:scale-105 group/qr">
          ...
          <!-- Hover Icon Overlay -->
          <div class="absolute inset-0 bg-[#FFF8F1]/80 dark:bg-gray-700/80 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity duration-300">
        ...
        <div class="flex flex-col mt-3 gap-1.5 text-center md:text-left flex-grow z-10">
          <h3 class="text-[#1F2937] dark:text-gray-100 text-[16px] font-extrabold tracking-tight">QR For your Profile</h3>
          <p class="text-[13px] text-[#6B7280] dark:text-gray-400 font-medium leading-relaxed max-w-[280px]">Scan the QR code to check in for the activity.</p>
        </div>
    ...
    <Teleport to="body">
      ...
      <div class="relative w-full max-w-md bg-[#FFFFFF] dark:bg-gray-800 rounded-[36px] shadow-[0_20px_70px_rgba(0,0,0,0.15)] border border-[#EBEBEB] dark:border-gray-700 p-8 flex flex-col gap-6 animate-[scaleIn_0.3s_cubic-bezier(0.16,1,0.3,1)]">
        
        <div class="flex items-center justify-between">
          <h2 class="text-[22px] font-extrabold text-[#1F2937] dark:text-gray-100 tracking-tight">Edit Profile</h2>
          <button @click="isEditProfileOpen = false" class="text-[#6B7280] hover:text-[#EF7722] hover:bg-[#FFF8F1] dark:hover:bg-gray-700 p-2 rounded-full transition-colors">
        ...
        <div class="flex flex-col gap-5">
          ...
          <div class="flex items-center gap-4 bg-[#FFF8F1]/50 dark:bg-gray-700/50 p-4 rounded-3xl border border-[#EBEBEB] dark:border-gray-600 group/editimg">
             <div @click="triggerFileInput" class="relative w-16 h-16 rounded-full bg-[#FFFFFF] dark:bg-gray-800 shadow-sm border-[3px] border-[#FFF8F1] dark:border-gray-700 overflow-hidden shrink-0 cursor-pointer ring-2 ring-[#EBEBEB] dark:ring-gray-600 group-hover/editimg:ring-[#FAA533] transition-colors">
             ...
             <div class="flex flex-col">
               <span class="text-[14px] font-bold text-[#1F2937] dark:text-gray-100">Profile Picture</span>
               <span class="text-[12px] text-[#6B7280] dark:text-gray-400">Click the image to change.</span>
             </div>
          </div>

          <div class="flex flex-col gap-1.5 relative group/input">
            <label class="text-[11px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-widest pl-1">Full Name</label>
            <input v-if="editFormData" v-model="editFormData.name" type="text" class="w-full bg-[#FFF8F1] dark:bg-gray-700 border border-[#EBEBEB] dark:border-gray-600 rounded-2xl px-5 py-3.5 text-sm font-medium text-[#1F2937] dark:text-gray-100 focus:outline-none focus:ring-[3px] focus:ring-[#FAA533]/30 focus:border-[#EF7722] focus:bg-[#FFFFFF] dark:focus:bg-gray-800 transition-all shadow-sm" />
          </div>
          <div class="flex flex-col gap-1.5 relative group/input">
            <label class="text-[11px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-widest pl-1">University</label>
            <input v-if="editFormData" v-model="editFormData.university" type="text" class="w-full bg-[#FFF8F1] dark:bg-gray-700 border border-[#EBEBEB] dark:border-gray-600 rounded-2xl px-5 py-3.5 text-sm font-medium text-[#1F2937] dark:text-gray-100 focus:outline-none focus:ring-[3px] focus:ring-[#FAA533]/30 focus:border-[#EF7722] focus:bg-[#FFFFFF] dark:focus:bg-gray-800 transition-all shadow-sm" />
          </div>
          <div class="flex flex-col gap-1.5 relative group/input">
            <label class="text-[11px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-widest pl-1">Date of Birth</label>
            <input v-if="editFormData" v-model="editFormData.dob" type="date" class="w-full bg-[#FFF8F1] dark:bg-gray-700 border border-[#EBEBEB] dark:border-gray-600 rounded-2xl px-5 py-3.5 text-sm font-medium text-[#1F2937] dark:text-gray-100 focus:outline-none focus:ring-[3px] focus:ring-[#FAA533]/30 focus:border-[#EF7722] focus:bg-[#FFFFFF] dark:focus:bg-gray-800 transition-all shadow-sm cursor-pointer hover:border-[#FAA533]/50" />
          </div>
        </div>
        <div class="flex justify-end gap-3 mt-4 pt-2 border-t border-[#EBEBEB] dark:border-gray-700">
          <button @click="isEditProfileOpen = false" class="px-6 py-2.5 rounded-full text-sm font-bold text-[#6B7280] hover:text-[#1F2937] dark:hover:text-gray-200 hover:bg-[#FFF8F1] dark:hover:bg-gray-700 transition-colors active:scale-95">Cancel</button>
    ...
    <Teleport to="body">
      ...
      <div class="relative w-full max-w-sm bg-[#FFFFFF] dark:bg-gray-800 rounded-[40px] shadow-[0_30px_100px_rgba(0,0,0,0.3)] border border-[#EBEBEB] dark:border-gray-700 p-8 flex flex-col items-center gap-6 animate-[scaleIn_0.4s_cubic-bezier(0.34,1.56,0.64,1)] overflow-hidden">
        ...
        <div class="relative z-10 w-full flex justify-between items-center mb-2">
          <h2 class="text-xl font-bold text-[#1F2937] dark:text-gray-100 tracking-wide">Your Profile QR</h2>
          <button @click="isQrModalOpen = false" class="text-[#6B7280] hover:text-[#EF7722] hover:bg-[#FFF8F1] dark:hover:bg-gray-700 p-2 rounded-full transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
          </button>
        </div>
        <div class="relative w-64 h-64 bg-[#FFF8F1] dark:bg-gray-700 rounded-[32px] p-4 shadow-inner border border-[#EBEBEB] dark:border-gray-600 z-10 group overflow-hidden flex items-center justify-center">
            <div class="w-full h-full border-4 border-dashed border-[#EBEBEB] dark:border-gray-600 rounded-[24px] flex flex-col items-center justify-center overflow-hidden relative bg-[#FFFFFF]/50 dark:bg-gray-800/50 backdrop-blur-sm">
        ...
        <button @click="isQrModalOpen = false" class="relative z-10 bg-[#FFF8F1] dark:bg-gray-700 hover:bg-[#FFFFFF] dark:hover:bg-gray-600 border border-[#EBEBEB] dark:border-gray-600 text-[#1F2937] dark:text-gray-200 hover:text-[#EF7722] font-bold text-sm py-3 px-10 rounded-full transition-all active:scale-95 shadow-sm w-full mt-2 tracking-wider">
          Close Window
        </button>
      </div>
      </div>
