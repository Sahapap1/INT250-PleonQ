...
<template>
    <div @click="goToDetail"
        class="h-37 w-full md:max-w-3xl bg-white dark:bg-gray-800 rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border p-2 pr-3 sm:pr-4 flex gap-2 sm:gap-4 relative group hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:border-[#FAA533]/40 transition-all duration-300 cursor-pointer overflow-hidden animate-fade-in-up"
        :class="data.liked ? 'border-[#FAA533]/70 ring-[1.5px] ring-[#FAA533]/20 shadow-[0_4px_15px_rgba(239,119,34,0.08)] bg-[#FFF8F1]/20 dark:bg-gray-800' : 'border-[#EBEBEB] dark:border-gray-700'">
        ...
        <div class="flex flex-col py-1.5 px-1 sm:px-2 grow min-w-0 overflow-hidden">
            ...
            <p class="text-[11px] text-gray-500 dark:text-gray-300 font-medium leading-relaxed max-w-[220px] mb-2 line-clamp-2">
                {{ data.description }}
            </p>
